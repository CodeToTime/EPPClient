      ...
      if (address.getIsNewContact()) {
        ...
        try {
          ...
          ContactCreate contactCreate =
              new ContactCreate(
                  ...
                  address.getVoice(),
                  address.getEmail(),
                  address.getConsentForPublishing());
        ...
        try {
          ...
          ContactInfoResponseExt contactInfoExt =
              (ContactInfoResponseExt) response.getResponseExtension();
          ...
          if (!contactInfoExt.isRegistrant()) {
            if (address.isIsRegistrantChanged()) {
              if (address.getIsRegistrant()) {
                contactUpdate.setExtRegistrant(
                    address.getNationalityCode(), address.getEntityType(), address.getRegCode());
              }
            }
          } else {
    ...
    String contactIds =
        (String)
            JOptionPane.showInputDialog(
                this,
                "Please digit contact IDs you want to Check for Availability",
  ...
  public void syncContactInfo() {
    String contactId =
        (String)
            JOptionPane.showInputDialog(
                this,
                "Please digit the contact ID you want to sync",
                "Contact Sync",
                JOptionPane.INFORMATION_MESSAGE,
                null,
                null,
                addressPanel.getContactId());
    ...
    if (contactId != null) {
      ...
      if (syncContact.execute()) {
        ...
        JOptionPane.showMessageDialog(
            this,
            "Si è verificato un errore durante la sincronizzazione dei dati del contatto "
                + contactId
                + "!",
            "Errore sincronizzazione contatto",
            JOptionPane.WARNING_MESSAGE);
      }
