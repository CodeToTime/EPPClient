...
public class InfoDialog {
  ...
  private static String buildText() {
    return "INFORMAZIONI DI COMPILAZIONE\n"
        + "----------------------------------------\n"
        + "Compilato su richiesta di: "
        + com.codetotime.eppclient.BuildInfo.BUILD_COMPANY
        + "\n\n"
        + "Partita IVA: "
        + com.codetotime.eppclient.BuildInfo.BUILD_PIVA
        + "\n\n"
        + "ID interno ordine: "
        + com.codetotime.eppclient.BuildInfo.BUILD_ORDER
        + "\n\n"
        + "TAG Registrar (NIC): "
        + com.codetotime.eppclient.BuildInfo.BUILD_REGISTRAR_TAG
        + "\n\n"
        + "Data di compilazione: "
        + com.codetotime.eppclient.BuildInfo.BUILD_DATE
        + "\n"
        + "----------------------------------------\n"
