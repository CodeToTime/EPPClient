...
public class TransferPanel extends JPanel {
  ...
  private void txtIsTradeActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_txtIsTradeActionPerformed
    setEditable(isEditable);
  } // GEN-LAST:event_txtIsTradeActionPerformed

  private void txtIsCancelActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_txtIsCancelActionPerformed
    setEditable(isEditable);
