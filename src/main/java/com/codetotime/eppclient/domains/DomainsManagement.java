...
public class DomainsManagement extends JFrame implements ActionListener, ListSelectionListener {
                            ...
                            .addGroup(
                                contentPaneLayout
                                    ...
                                    .addComponent(
                                        ...
                                        GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(
                                        LayoutStyle.ComponentPlacement.RELATED, 33, Short.MAX_VALUE)
                                    .addComponent(
                                        addressActionPanel,
                                        GroupLayout.PREFERRED_SIZE,
                                        GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.PREFERRED_SIZE))
                            .addComponent(
                                addressListPanel, GroupLayout.DEFAULT_SIZE, 783, Short.MAX_VALUE))
                    .addContainerGap()));
    pack();
  ...
  private void deleteDomain() {
    ...
    if (JOptionPane.showOptionDialog(
            this,
            "Do you REALLY want to delete the domain " + domainName + "?",
        ...
        try {
          ...
          if (response.isSuccessfully()) {
            DomainCreateResponseResData domainCreateResData =
                (DomainCreateResponseResData) response.getResponseResData();
                ...
                if (removeOldStatus) {
                  switch (status) {
                    case 0:
                      ...
                      break;
                    case 1:
                      domainUpdate.addStatusToRem(
                          DomainUpdateStatusType.CLIENT_TRANSFER_PROHIBITED);
                      break;
                    case 2:
    ...
    String domainName =
        (String)
            JOptionPane.showInputDialog(
                this,
                "Please digit the domain name you want to sync",
                "Domain Sync",
                JOptionPane.INFORMATION_MESSAGE,
                null,
                null,
                domainPanel.getDomainName());
            ...
            switch (syncDomain.getReasonCode()) {
              case 9036:
                JOptionPane.showMessageDialog(
                    this,
                    "Il dominio " + domainName + " non esiste!",
                    "Dominio inesistente",
                    JOptionPane.WARNING_MESSAGE);
                break;
            }
          ...
          case 2202:
            switch (syncDomain.getReasonCode()) {
              case 9001:
                JOptionPane.showMessageDialog(
                    this,
                    "Il dominio " + domainName + " appartiene ad un altro Registrar!",
  ...
  private void checkDomain() {
    String domains =
        (String)
            JOptionPane.showInputDialog(
                this,
                "Please digit the domain(s) you want to Check for Availability",
    ...
    try {
      ...
      if (response.isSuccessfully()) {
        ...
        DomainCheckResponseResData resData =
            (DomainCheckResponseResData) response.getResponseResData();
        ...
        JOptionPane.showMessageDialog(
            this, msgAvailabilityResult, "Contact Check Result", JOptionPane.INFORMATION_MESSAGE);
      } else {
        if (JOptionPane.showConfirmDialog(
                this,
  ...
  public void restoreDomain() {
    String domainName =
        (String)
            JOptionPane.showInputDialog(
                this,
                "Please digit the domain name you want to restore",
                "Domain Restore from RGP",
                JOptionPane.INFORMATION_MESSAGE,
                null,
                null,
                domainPanel.getDomainName());
      ...
      try {
        ...
        if (response.isSuccessfully()) {
          ...
          if (syncDomain.execute(domainName)) {
            ...
            JOptionPane.showMessageDialog(
                this,
                "The domain name \"" + domainName + "\" has been successfully Restored.",
                "Domain Restore from RGP Result",
                JOptionPane.INFORMATION_MESSAGE);
          }
