...
public class UpdateChecker {
              ...
              try {
                ...
                if (!newerReleases.isEmpty()) {
                  SwingUtilities.invokeLater(
                      () -> showUpdateDialog(parent, currentVersion, newerReleases));
                }
              } catch (Exception e) {
  ...
  private static List<ReleaseInfo> fetchNewerReleases(String currentVersion) throws Exception {
    ...
    for (JsonElement element : releases) {
      ...
      String releaseName =
          release.has("name") && !release.get("name").isJsonNull()
  ...
  private static void showUpdateDialog(
    ...
    JOptionPane.showMessageDialog(
        parent, scrollPane, "Aggiornamento disponibile", JOptionPane.INFORMATION_MESSAGE);
  }
