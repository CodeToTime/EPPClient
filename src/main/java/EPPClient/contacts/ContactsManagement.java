...
//                        db.disconnect();
  ...
  public void syncContactInfo()
  {
    ...
    if (contactId != null)
    {
      ...
      {
        JOptionPane.showMessageDialog(this, "Si è verificato un errore durante la sincronizzazione dei dati del contatto " + contactId + "!", "Errore sincronizzazione contatto", JOptionPane.WARNING_MESSAGE);
      }
